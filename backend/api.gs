...
const SCHEMAS = {
  ...
  Vehicles:      ['id','name','make','model','variant','year','engine','fuelType','regNumber','vin','purchaseDate','purchaseOdo','purchasePrice','tankCapacityL','currentOdo','isActive','category','notes','createdAt','expectedLifeKm','expectedLifeYears','annualKmEstimate','serviceChecklist'],
