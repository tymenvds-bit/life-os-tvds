...
const SCHEMAS = {
  ...
  Vehicles:      ['id','name','make','model','variant','year','engine','fuelType','regNumber','vin','purchaseDate','purchaseOdo','purchasePrice','tankCapacityL','currentOdo','isActive','category','notes','createdAt','expectedLifeKm','expectedLifeYears','annualKmEstimate','serviceChecklist','oilSpec','oilCapacityL','coolantType','coolantCapacityL','brakeFluidType','transFluidType','diffFluidType','tyreSize','tyrePressureFront','tyrePressureRear','tyrePressureSpare'],
  ...
  VehicleParts: ['id','vehicleId','partNumber','description','category','brand','supplier','qtyOnHand','qtyMin','unitPrice','location','compatibleVehicles','notes','createdAt'],
  VehicleTyres: ['id','vehicleId','brand','model','size','dotCode','purchaseDate','purchaseOdo','purchasePrice','currentPosition','isSpare','isActive','totalKm','notes','createdAt'],
  TyreRotations: ['id','vehicleId','date','odometer','moves','notes','createdAt'],
  Modifications: ['id','vehicleId','date','category','description','cost','supplier','affectsResale','notes','createdAt'],
  Incidents: ['id','vehicleId','date','odometer','description','thirdParty','claimNumber','insurerResponse','coPayment','totalCost','resolved','notes','createdAt'],
